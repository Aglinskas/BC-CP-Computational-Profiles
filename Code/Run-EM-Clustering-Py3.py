...
masker = NiftiMasker(mask_img=mfn)
...
model = mixture.BayesianGaussianMixture(max_iter=100,
                                      n_components=20,covariance_type='full',
                                      init_params='kmeans',
...
ofn= os.path.join(root,'Results','{}-cid6-test.nii'.format(sub))
#oDS = copy.deepcopy(ds)
#oDS.samples=Co
